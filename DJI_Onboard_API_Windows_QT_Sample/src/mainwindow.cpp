...
void MainWindow::on_BtnActivation_clicked()
{
    ...
    *keybuf = ui->AppKey->text().toLocal8Bit();
    ...
    ui->AppID->setEnabled(false);
    ui->AppKey->setEnabled(false);
}
...
{
    //we not use keyPress because array key bug here,so we use keyRelease instead
    /*
    switch (event->key())
    {
        case Qt::Key_W:
        ...
        break;
        case Qt::Key_Up:
        printf("Array_Up key press\n");
        break;
        case Qt::Key_Down:
        printf("Array_Down key press\n");
        break;
        case Qt::Key_Left:
        printf("Array_Left key press\n");
        break;
        case Qt::Key_Right:
        printf("Array_Right key press\n");
        break;
        default:
        break;
    }
